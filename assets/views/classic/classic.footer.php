<footer>
    <div class="container pt-5 pb-4">
        <div class="row justify-content-center">
            <div class="col-xl-11 footer-links">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 mb-2">
                        <a href="#">Netflux Originals</a>
                    </div>
                </div>

                <div class="position-relative language-selector mt-4">
                    <svg version="1.1" fill="#999" xmlns="http://www.w3.org/2000/svg"
	...
	h3.2C48.8,52.8,46.4,54.6,43.7,56z" />
                    ...
                    <select onchange="SelectLang();" class="lang-select lang-select-dark" name="language-select"
                        id="language-select">
                        <?php
