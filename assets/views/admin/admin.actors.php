...
<div class="content">
    ...
    <div class="row">
        <div style="display: inline-block;" class="col-6">
            <h1><?= StaticFunctions::lang('100_actors') ?></h1>
        </div>
    ...
    <div class="table table-datatable">
        <table id="DataTableD" data-source="actors" class="data-table" class="display" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
                    <th><?= StaticFunctions::lang('145_actor') ?></th>
                    <th><?= StaticFunctions::lang('146_actor') ?></th>
...
<div class="modal js-modal" data-name="first-modal">
    ...
    <div style="margin-top: 180px;" class="modal-content">
        <div class="hero"><?= StaticFunctions::lang('148_add-new') ?></div>
        <a href="javascript:;" class="close js-modal-close">
            <em class="fa fa-close"></em>
        </a>
        <form onsubmit="SubmitForm(this);" data-source="web-service/new/actor" action="javascript:;" action="" method="post">
            <div class="fields">
                <div class="field">
                    <label>
                        <?= StaticFunctions::lang('145_actor') ?>
                        <input required name="actor_name" placeholder="<?= StaticFunctions::lang('149_actor-s') ?>" type="text" />
                    </label>
                </div>
            </div>
...
<div class="modal js-modal" data-name="first-modal2">
    <div class="backdrop"></div>
    <div style="margin-top: 180px;" class="modal-content">
        <div class="hero"><?= StaticFunctions::lang('151_edit') ?></div>
        <a href="javascript:;" class="close js-modal-close">
            <em class="fa fa-close"></em>
        </a>
        <form onsubmit="SubmitForm(this);" data-source="web-service/edit/actor" action="javascript:;" action="" method="post">
            <div class="fields">
                <div class="field">
                    <label>
                        <?= StaticFunctions::lang('145_actor') ?>
                        <input required name="edit_actor_name" placeholder="<?= StaticFunctions::lang('149_actor-s') ?>" type="text" />
