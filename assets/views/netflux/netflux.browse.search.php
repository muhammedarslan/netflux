    ...
    <section class="entity-showcase">
        ...
        <div style="padding-top: 80px;" class="entity-carousel">
            <div style="font-weight:normal;" class="carousel-title">
                <?= StaticFunctions::lang('359_search') . $SearchQuery ?>
            </div>
        </div>



        <div data-source="list/search" data-send="<?= $SearchQuery ?>" data-title="null" class="entity-carousel list_videos list-container list-container-relative">
