...
.category-selector .dropdown ul {
 ...
 <img style="max-width: 650px;max-height:230px;" class="entity-logo mb-4"
    ...
    line-height: 80px;"><?= StaticFunctions::VideoTranslation(@$LastVideo['video_name'], @$LastVideo['video_translations'], 'name') ?></span>
            ...
            <div data-single="row" data-hide="null" data-source="list/populer/movies"
    ...
    <section class="entity-showcase">
        ...
        if ($ProfileLevel == 5) {
            ...
            if ($KidsGenre) {
                echo '<div data-source="list/genres/movie" data-single="row" data-hide="null" data-send="' . $KidsGenre['id'] . '" data-title="' . StaticFunctions::GenreTranslation($KidsGenre['genres_name'], $KidsGenre['genre_translations']) . '" class="entity-carousel list_videos list-container list-container-relative">
        ...
        if ($Genres->rowCount()) {
            foreach ($Genres as $row) {
                echo '<div data-source="list/genres/movie" data-single="row" data-hide="null" data-send="' . $row['id'] . '" data-title="' . StaticFunctions::GenreTranslation($row['genres_name'], $row['genre_translations']) . '" class="entity-carousel list_videos list_videos list-container list-container-relative">
