    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n) {
        (0, o.default)([t]).forEach(function (t) {
          ...
          document
            .getElementById(t.getAttribute("data-button-id"))
            .addEventListener("click", function () {
              e.split(f.SEPARATOR_RULE).forEach(function (e) {
                ...
                if (a == true) {
                  var ButtonEvent = document
                    .getElementById(t.getAttribute("data-button-id"))
                    .getAttribute("data-click-event");
                  eval(ButtonEvent);
                }
        ...
        (h.abs = function () {
          ...
          (h.minus = h.sub = function (t) {
            ...
            if ((f = a - p)) {
              ...
              for (
                n = ((o = s.length < l.length) ? s : l).length, f = c = 0;
                c < n;
                c++
              )
                if (s[c] != l[c]) {
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, o) {
        ...
        n
          ...
          : (i
              ? ((i.innerHTML = $(t).attr("data-error-text")),
