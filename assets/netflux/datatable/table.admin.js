    ...
    initComplete: function (settings, json) {
      if (Options.Export == true) {
        ...
        setTimeout(() => {
          ...
          getScripts(
            [
              "/assets/netflux/datatable/buttons.html5.min.js",
              "/assets/netflux/datatable/buttons.print.min.js",
              "/assets/netflux/datatable/pdfmake.min.js",
              "/assets/netflux/datatable/vfs_fonts.js",
              "/assets/netflux/datatable/jszip.min.js",
            ],
            () => {
